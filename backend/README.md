...
## Project Structure
    ...
    ├── testapiautostorybo_107408  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_107408`
...
2. Clone this repo and `cd testapiautostorybo_107408`
